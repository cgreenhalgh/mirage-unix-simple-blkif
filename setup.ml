...
(* OASIS_START *)
(* DO NOT EDIT (digest: 62b9f9cf62494b8f096f7059e8d15ecb) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$blkdev_test", []))];
            ...
            [
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "unix-simple-blkdev";
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "unix_simple_blkdev";
                           FindlibPackage ("mirage", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = true; exec_main_is = "blkdev_test.ml"; });
               Test
                 ({
                     cs_name = "blkdev_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "q(+\241\016\225\170\235h~O\027\255&\157Q";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
